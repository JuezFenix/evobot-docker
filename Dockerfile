...
ENV LAST_UPDATE=21_09_2021

ENV USER=evobot
ENV EVOBOT_VERSION=0.15.2
...
# install requisites
RUN npm install i18n --save && npm install i18n-js@latest ytdl-core@latest ytdl-core-discord@latest node-opus@latest
